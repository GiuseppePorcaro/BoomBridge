...
public class BroadPhase {
  ...
  public int createProxy(AABB aabb, SWIGTYPE_p_void userData) {
    return liquidfunJNI.BroadPhase_createProxy(swigCPtr, this, AABB.getCPtr(aabb), aabb, SWIGTYPE_p_void.getCPtr(userData));
  }
  ...
  public SWIGTYPE_p_void getUserData(int proxyId) {
    long cPtr = liquidfunJNI.BroadPhase_getUserData(swigCPtr, this, proxyId);
