...
public class ContactManager {
  ...
  public void addPair(SWIGTYPE_p_void proxyUserDataA, SWIGTYPE_p_void proxyUserDataB) {
    liquidfunJNI.ContactManager_addPair(swigCPtr, this, SWIGTYPE_p_void.getCPtr(proxyUserDataA), SWIGTYPE_p_void.getCPtr(proxyUserDataB));
  }
  ...
  public void setContactFilter(ContactFilter value) {
    liquidfunJNI.ContactManager_contactFilter_set(swigCPtr, this, ContactFilter.getCPtr(value), value);
  }

  public ContactFilter getContactFilter() {
    long cPtr = liquidfunJNI.ContactManager_contactFilter_get(swigCPtr, this);
    return (cPtr == 0) ? null : new ContactFilter(cPtr, false);
  }
