...
public class liquidfun implements liquidfunConstants {
  public static SWIGTYPE_p_void b2Alloc(int size) {
    long cPtr = liquidfunJNI.b2Alloc(size);
    return (cPtr == 0) ? null : new SWIGTYPE_p_void(cPtr, false);
  }

  public static void b2Free(SWIGTYPE_p_void mem) {
    liquidfunJNI.b2Free(SWIGTYPE_p_void.getCPtr(mem));
  }

  public static void b2SetAllocFreeCallbacks(SWIGTYPE_p_f_int_p_void__p_void allocCallback, SWIGTYPE_p_f_p_void_p_void__void freeCallback, SWIGTYPE_p_void callbackData) {
    liquidfunJNI.b2SetAllocFreeCallbacks(SWIGTYPE_p_f_int_p_void__p_void.getCPtr(allocCallback), SWIGTYPE_p_f_p_void_p_void__void.getCPtr(freeCallback), SWIGTYPE_p_void.getCPtr(callbackData));
  }
