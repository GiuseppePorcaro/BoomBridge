...
public class DynamicTree {
  ...
  public int createProxy(AABB aabb, SWIGTYPE_p_void userData) {
    return liquidfunJNI.DynamicTree_createProxy(swigCPtr, this, AABB.getCPtr(aabb), aabb, SWIGTYPE_p_void.getCPtr(userData));
  }
  ...
  public SWIGTYPE_p_void getUserData(int proxyId) {
    long cPtr = liquidfunJNI.DynamicTree_getUserData(swigCPtr, this, proxyId);
