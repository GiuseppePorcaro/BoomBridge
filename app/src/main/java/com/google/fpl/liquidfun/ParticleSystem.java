...
public class ParticleSystem {
  ...
  public int copyPositionBuffer(int startIndex, int numParticles, SWIGTYPE_p_void outBuf, int size) {
    return liquidfunJNI.ParticleSystem_copyPositionBuffer(swigCPtr, this, startIndex, numParticles, SWIGTYPE_p_void.getCPtr(outBuf), size);
  }

  public int copyColorBuffer(int startIndex, int numParticles, SWIGTYPE_p_void outBuf, int size) {
    return liquidfunJNI.ParticleSystem_copyColorBuffer(swigCPtr, this, startIndex, numParticles, SWIGTYPE_p_void.getCPtr(outBuf), size);
  }

  public int copyWeightBuffer(int startIndex, int numParticles, SWIGTYPE_p_void outBuf, int size) {
    return liquidfunJNI.ParticleSystem_copyWeightBuffer(swigCPtr, this, startIndex, numParticles, SWIGTYPE_p_void.getCPtr(outBuf), size);
  }
